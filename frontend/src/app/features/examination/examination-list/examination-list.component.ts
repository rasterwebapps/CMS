...
import { EXAMINATION_LIST_TOUR, EXAMINATION_LIST_FLOW_MAP } from '../../../shared/tour/tours/examination.tours';
...
export class ExaminationListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.tourService.register('examination-list', EXAMINATION_LIST_TOUR);
    this.tourService.registerFlowMap('examination-list', EXAMINATION_LIST_FLOW_MAP);
    this.load();
  }
