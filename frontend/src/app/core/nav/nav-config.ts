...
export const NAV_ENTRIES: NavEntry[] = [
  ...
  // Also shares the one toggleable INVENTORY module.
  {
    ...
    items: [
      ...
      { label: 'Price Comparison', icon: 'paid', route: '/inventory/reporting/price-comparison', permissions: ['INVENTORY_VENDOR_PRODUCT_MAPPING_VIEW', 'INVENTORY_VENDOR_PRODUCT_MAPPING_MANAGE'] },
      ...
      { label: 'Quotation Requests', icon: 'request_quote', route: '/inventory/procurement/quotation-requests', permissions: ['INVENTORY_QUOTATION_VIEW', 'INVENTORY_QUOTATION_MANAGE', 'INVENTORY_QUOTATION_AWARD'] },
  ...
  // See docs/inventory-management/DECISION_LOG.md's "Gate Pass slice" entry.
  {
    ...
    items: [
      ...
      { label: 'Service Tickets', icon: 'support_agent', route: '/inventory/ticket/tickets', permissions: ['INVENTORY_SERVICE_TICKET_VIEW', 'INVENTORY_SERVICE_TICKET_MANAGE', 'INVENTORY_SERVICE_TICKET_ASSIGN', 'INVENTORY_SERVICE_TICKET_RESOLVE', 'INVENTORY_SERVICE_TICKET_CLOSE'] },
      { label: 'Ticket Categories', icon: 'sell', route: '/inventory/ticket/categories', permissions: ['INVENTORY_SERVICE_TICKET_CATEGORY_VIEW', 'INVENTORY_SERVICE_TICKET_CATEGORY_MANAGE'] },
    ],
  },
