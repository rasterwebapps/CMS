...
- **Frontend:** Skeleton Builder, Staffing, Capacity Planner (incl. Faculty Workload tab), Faculty Workload Rules screen — all under the Academics nav group. The manual Rotation Setup and Place Elective Block flyouts were removed on 2026-09-15: Run Automation builds Lab rotations and places elective groups itself (`RotationGroupController` and the elective-place endpoint remain).
