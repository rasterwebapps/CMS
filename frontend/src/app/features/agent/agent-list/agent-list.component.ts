...
@Component({
  ...
  imports: [
    ...
    MatProgressSpinnerModule, MatDialogModule, MatTooltipModule, MatChipsModule],
...
export class AgentListComponent implements OnInit {
  ...
  // ── Column visibility ────────────────────────────────────────────────────
  protected readonly ALL_COLS = ['name', 'phone', 'email', 'area', 'allottedSeats', 'isActive', 'actions'];
  ...
  private readonly COLS_KEY = 'agent-list-cols';
  ...
  protected edit(item: Agent): void { void this.router.navigate(['/agents', item.id, 'edit']); }
