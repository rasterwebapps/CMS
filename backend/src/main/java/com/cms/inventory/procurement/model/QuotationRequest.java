...
/**
 * A Quotation Request (RFQ) header — an OPTIONAL step between Purchase Requisition and Purchase
 * Order. Invites one or more {@link Supplier}s to quote against a set of {@code APPROVED} {@link
 * PurchaseRequisitionItem} lines for one location; staff key in each supplier's quoted price once
 * received (no outbound email/portal exists anywhere in this module). Mirrors {@link
 * PurchaseRequisition}'s shape closely. See the "Quotation Request slice" decision-log entry.
 */
@Entity
