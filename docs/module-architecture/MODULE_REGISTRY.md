...
| `INVENTORY` | Inventory Management | Inventory Management (legacy asset tracking), Stock Management, Purchasing & Suppliers — unified into one module, + Preferences: Equipment | `INVENTORY_`, `MAINTENANCE_`, `EQUIPMENT_` | — |
