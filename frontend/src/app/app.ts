  ...
  private readonly navEntries: NavEntry[] = [
    ...
    // 5. Academics
    {
      ...
      items: [
        ...
        { label: 'CO/PO Mapping',       icon: 'account_tree',       route: '/curriculum-mappings', permissions: ['COPO_VIEW', 'COPO_CREATE', 'COPO_EDIT', 'COPO_DELETE', 'COPO_MANAGE', 'CURRICULUM_VIEW'] },
        { label: 'Curriculum Versions', icon: 'layers',             route: '/curriculum-versions', permissions: ['CURRICULUM_VIEW', 'CURRICULUM_CREATE', 'CURRICULUM_EDIT', 'CURRICULUM_DELETE', 'CURRICULUM_MANAGE'] },
    ...
    // 6. Library
    {
      ...
      items: [
        ...
        { label: 'Issue Book',       icon: 'add_circle_outline', route: '/library/issues/new',     permissions: ['LIBRARY_ISSUE_CREATE', 'LIBRARY_ISSUE_MANAGE'] },
        { label: 'My Library',       icon: 'person',             route: '/library/my-issues',      permissions: ['LIBRARY_ISSUE_VIEW'] },
        { label: 'Journals',         icon: 'newspaper',          route: '/library/periodicals',    permissions: ['LIBRARY_PERIODICAL_VIEW', 'LIBRARY_PERIODICAL_CREATE', 'LIBRARY_PERIODICAL_EDIT', 'LIBRARY_PERIODICAL_DELETE', 'LIBRARY_PERIODICAL_EXPORT', 'LIBRARY_PERIODICAL_MANAGE'] },
    ...
    // 9. Preferences
    {
      ...
      icon: 'tune',
      items: [
        { label: 'Academic Calendar',  icon: 'event_note',        route: '/academic-calendar',       permissions: ['ACADEMIC_YEAR_VIEW', 'ACADEMIC_YEAR_CREATE', 'ACADEMIC_YEAR_EDIT', 'ACADEMIC_YEAR_MANAGE'] },
        ...
        { label: 'Faculty Doc Config', icon: 'rule',              route: '/faculty/document-config', permissions: ['FACULTY_EDIT', 'FACULTY_MANAGE'] },
