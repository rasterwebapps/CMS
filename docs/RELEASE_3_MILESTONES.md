...
| R3-M6: Approvals & Gate Pass | 🟡 In Progress — Budget allocation/tracking shipped (informational allocated-vs-consumed, computed live from sent Purchase Orders); multi-level approval routing and exception handling still to come | 15% |
