...
class ProgramControllerTest {
    ...
    void shouldCreateProgram() throws Exception {
        ProgramRequest request = new ProgramRequest("UG Program", "UG", 4, null, null, 17, 31, 12, false);

        Instant now = Instant.now();
        ProgramResponse response = new ProgramResponse(1L, "UG Program", "UG", 4, 8, null, com.cms.model.enums.AssessmentPattern.TERM_BASED, Set.of(), Set.of(), null, null, null, null, now, now);
    ...
    void shouldReturnBadRequestWhenNameIsBlank() throws Exception {
        ProgramRequest request = new ProgramRequest("", "UG", 4, null, null, null, null, null, false);
    ...
    void shouldReturnBadRequestWhenCodeIsBlank() throws Exception {
        ProgramRequest request = new ProgramRequest("UG Program", "", 4, null, null, null, null, null, false);
    ...
    void shouldFindAllPrograms() throws Exception {
        Instant now = Instant.now();
        ProgramResponse prog1 = new ProgramResponse(1L, "Bachelor", "BACHELOR", 4, 8, null, com.cms.model.enums.AssessmentPattern.TERM_BASED, Set.of(), Set.of(), null, null, null, null, now, now);
        ProgramResponse prog2 = new ProgramResponse(2L, "Master", "MASTER", 2, 4, null, com.cms.model.enums.AssessmentPattern.TERM_BASED, Set.of(), Set.of(), null, null, null, null, now, now);
    ...
    void shouldFindProgramById() throws Exception {
        Instant now = Instant.now();
        ProgramResponse response = new ProgramResponse(1L, "Bachelor", "BACHELOR", 4, 8, null, com.cms.model.enums.AssessmentPattern.TERM_BASED, Set.of(), Set.of(), null, null, null, null, now, now);
    ...
    void shouldUpdateProgram() throws Exception {
        ProgramRequest request = new ProgramRequest("Bachelor Updated", "BACHELOR", 4, null, null, 17, 31, 12, false);

        Instant now = Instant.now();
        ProgramResponse response = new ProgramResponse(1L, "Bachelor Updated", "BACHELOR", 4, 8, null, com.cms.model.enums.AssessmentPattern.TERM_BASED, Set.of(), Set.of(), null, null, null, null, now, now);
    ...
    void shouldReturnNotFoundWhenUpdatingNonExistentProgram() throws Exception {
        ProgramRequest request = new ProgramRequest("Name", "CODE", 4, null, null, 17, 31, 12, false);
    ...
    void shouldReturnBadRequestWhenUpdatingWithInvalidData() throws Exception {
        ProgramRequest request = new ProgramRequest("", "", 4, null, null, null, null, null, false);
