...
| R3-M5: Asset Management | 🟡 In Progress — Asset register (individual physical units, open-ended status lifecycle, optional GRN traceability) shipped; maintenance/service contracts, depreciation, and disposal still to come | 25% |
