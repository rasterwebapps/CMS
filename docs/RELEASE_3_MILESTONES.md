...
| R3-M6: Approvals & Gate Pass | 🟡 In Progress — Budget allocation/tracking, Multi-level approval routing, and Exception handling (bypass with documented reason) all shipped; gate pass and vendor-owned stock still to come | 60% |
