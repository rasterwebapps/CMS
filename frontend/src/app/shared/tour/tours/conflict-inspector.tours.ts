  ...
  steps: [
    ...
    },
    {
      popover: {
        ...
        description:
          'Fix flagged sessions in Timetable Builder or Staffing, then come back and Rescan — the term can\'t be published until this list is empty.',
        side: 'over',
        align: 'center',
      },
    },
...
export const CONFLICT_INSPECTOR_FLOW_MAP: TourFlowMap = {
  ...
  steps: [
    ...
    { label: 'Fix and Rescan', icon: 'send', detail: 'Fix flagged sessions in Timetable Builder or Staffing, then rescan until the list is clean.' },
