 ...
 * state with nothing yet to pick up downstream. See the "Stock Indent slice" decision-log
 * entry.
 */
@Entity
@Table(name = "stock_indents")
public class StockIndent {
    ...
    private StockIndentStatus status = StockIndentStatus.DRAFT;
    ...
    public StockIndentStatus getStatus() { return status; }
    public void setStatus(StockIndentStatus status) { this.status = status; }
