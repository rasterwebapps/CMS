...
public class StockIndent {
    ...
    /** True when created by {@code AutoIndentService}'s reorder-breach detection rather than a
     *  person — same lifecycle either way (see the "OC-206 reopened" decision-log entry). */
