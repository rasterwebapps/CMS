...
export const WIDGET_REGISTRY: WidgetDef[] = [
  ...
  { key: 'stat-govt-lapsed-seats',  label: 'Govt. Lapsed Seats',  description: 'Government quota seats unfilled (counselling seats − admitted)', icon: 'event_seat', category: 'stats', component: StatCardWidgetComponent, defaultColSpan: 1, defaultRowSpan: 1 },
  // ── Charts ────────────────────────────────────────────────────────────────
