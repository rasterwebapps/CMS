...
export class ExperimentListComponent implements OnInit {
  ...
  // ── Column visibility ────────────────────────────────────────────────────
  protected readonly ALL_COLS = ['experimentNumber', 'name', 'courseName', 'courseCode', 'estimatedDurationMinutes', 'isActive', 'actions'];
  ...
  private readonly COLS_KEY = 'experiment-list-cols';
