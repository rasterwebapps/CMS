...
| R3-M6: Approvals & Gate Pass | 🟡 In Progress — Budget allocation/tracking, Multi-level approval routing, Exception handling, and Outward/inward Gate Pass (with overdue alerts) all shipped; vendor-owned (consignment) stock and internal service ticketing still to come | 70% |
