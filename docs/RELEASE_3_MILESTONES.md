...
| R3-M6: Approvals & Gate Pass | 🟡 In Progress — Budget allocation/tracking and Multi-level approval routing (standalone sequential/parallel engine, optional gate) both shipped; exception handling and gate pass still to come | 40% |
