...
export const WIDGET_REGISTRY: WidgetDef[] = [
  ...
  { key: 'student-faculty-ratio', label: 'Student : Faculty Ratio', description: 'Speciality-wise compliance ratio with threshold marker', icon: 'groups_2', category: 'charts', component: Tier3StrategicWidgetComponent, defaultColSpan: 2, defaultRowSpan: 1 },
