...
import { CohortRoomAllocation, CohortSectionRequest, VentureSplit } from './cohort-room-allocation.model';
    ...
    this.capacityPlannerService.getPlan(termInstanceId, cohortId, this.planningBasis)
      .subscribe({
        next: (data) => {
          ...
          if (this.canManageAllocation()) this.autoGenerateDraftSections(data);
        },
        error: (err) => {
