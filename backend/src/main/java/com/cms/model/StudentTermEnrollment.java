...
@Entity
@Table(name = "student_term_enrollments",
    uniqueConstraints = @UniqueConstraint(columnNames = {"student_id", "term_instance_id"}))
@EntityListeners(AuditingEntityListener.class)
public class StudentTermEnrollment {
