...
| R3-M4: Requisition & Issue | 🟡 In Progress — Stock Issue Request and Internal Return shipped; auto-restocking (needs product-policy input, flagged) and loanable-item issue still to come | 50% |
