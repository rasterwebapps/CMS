...
| R3-M4: Requisition & Issue | 🟡 In Progress — Stock Indent (renamed 2026-09-21 from Stock Issue Request), Internal Return, and Loanable Item Issue all shipped; Auto-Indent reopened 2026-09-21 with real user policy input, per-location config/detection job/fulfillment screen still to build (see DECISION_LOG.md) | 80% |
