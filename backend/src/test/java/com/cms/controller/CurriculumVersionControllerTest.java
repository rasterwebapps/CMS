...
class CurriculumVersionControllerTest {
    ...
    void shouldReturnBadRequestWhenVersionNameIsBlank() throws Exception {
        CurriculumVersionRequest request = new CurriculumVersionRequest(1L, 1L, "", 1L, true);
    ...
    private CurriculumVersionDto createDto(Long id, Long programId, String programName,
        ...
        return new CurriculumVersionDto(id, programId, programName, 100L, "Test Course", versionName, ayId, ayName,
            isActive, 0, 0, true, Instant.now(), Instant.now());
    }
}
