...
const SORT_FIELD_MAP: Record<string, string> = {
  ...
  status:                'status',
  // FeeRefund is a flat/denormalized entity (see model/FeeRefund.java) — there is
  // no `receipt` relation, just direct scalar columns. The old 'receipt.receiptNumber'
  // path pointed at a property that doesn't exist and would 500 on click.
